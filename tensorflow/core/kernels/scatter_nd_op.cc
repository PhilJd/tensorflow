...
TF_CALL_bool(REGISTER_SCATTER_ND_UPDATE_GPU);
...
#define DECLARE_GPU_SPECS_UPDATE(T)                                      \
  DECLARE_GPU_SPECS_INDEX_OP(T, int32, scatter_nd_op::UpdateOp::ASSIGN); \
  DECLARE_GPU_SPECS_INDEX_OP(T, int64, scatter_nd_op::UpdateOp::ASSIGN);
